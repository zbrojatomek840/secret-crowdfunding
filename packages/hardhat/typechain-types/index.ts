...
export type { SecretCrowdfunding } from "./contracts/SecretCrowdfunding";
export { SecretCrowdfunding__factory } from "./factories/contracts/SecretCrowdfunding__factory";
